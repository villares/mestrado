...
Código, Descrição, Cod1, Cod2, Cod3 [, CodN]... 
"""
...
def setup():
    size(800, 800)
    strokeWeight(3)
    ambientes = leitura_tabela("a.txt")
    print(ambientes)
...
class Ponto():
    ...
    def __init__(self, x, y, cod, desc):
        self.cod = cod
        self.desc = desc
        self.x = x
        self.y = y
